...
inp = ["Assignment2_Spring2020_Data1.txt", "Assignment2_Spring2020_Data2.txt", "Assignment2_Spring2020_Data3.txt"]
...
for ii in range(numOfFile):
    ...
    if rankA == n:
        ...
        f.write("{}\n".format("Unique Sulotion: " + strX)) 
        f.write("{}".format("Inverted A: "+ invA + "\n"))
        ...
        f.write("{}\n".format("Arbitrary variables: " + arb)) 
        f.write("{}\n".format("Arbitrary solutions: " + strX + "\n"))
        

    
    else:
        
        f.write("{}\n".format("Inconsistent problem\n")) 
